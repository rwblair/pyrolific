...
T = TypeVar("T", bound="MutuallyExclusiveStudyCollectionCreate")


@_attrs_define
class MutuallyExclusiveStudyCollectionCreate:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        mutually_exclusive_study_collection_create = cls(
            name=name,
            description=description,
            project_id=project_id,
            id=id,
        ...
        mutually_exclusive_study_collection_create.additional_properties = d
        return mutually_exclusive_study_collection_create
