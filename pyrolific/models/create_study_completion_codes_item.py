...
from ..models.create_study_completion_codes_item_code_type import CreateStudyCompletionCodesItemCodeType
...
T = TypeVar("T", bound="CreateStudyCompletionCodesItem")


@attr.s(auto_attribs=True)
class CreateStudyCompletionCodesItem:
    """
    Attributes:
        ...
        code_type (CreateStudyCompletionCodesItemCodeType): A name for your code to make it easier to understand its
    ...
    code: str
    code_type: CreateStudyCompletionCodesItemCodeType
    actions: List[
        Union[
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        code_type = CreateStudyCompletionCodesItemCodeType(d.pop("code_type"))
        ...
        create_study_completion_codes_item = cls(
            code=code,
            code_type=code_type,
            actions=actions,
        )

        create_study_completion_codes_item.additional_properties = d
        return create_study_completion_codes_item
