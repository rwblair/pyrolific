...
T = TypeVar("T", bound="UpdateFilterSetResponse200")


@attr.s(auto_attribs=True)
class UpdateFilterSetResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        update_filter_set_response_200 = cls(
            id=id,
            version=version,
        ...
        update_filter_set_response_200.additional_properties = d
        return update_filter_set_response_200
