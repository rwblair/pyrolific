...
T = TypeVar("T", bound="PostApiV1StudiesIdCloneJsonBody")


@attr.s(auto_attribs=True)
class PostApiV1StudiesIdCloneJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        post_api_v1_studies_id_clone_json_body = cls(
            block_previous_participants=block_previous_participants,
        )

        post_api_v1_studies_id_clone_json_body.additional_properties = d
        return post_api_v1_studies_id_clone_json_body
