...
T = TypeVar("T", bound="GetFilterSetResponse200")


@_attrs_define
class GetFilterSetResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        get_filter_set_response_200 = cls(
            id=id,
            version=version,
        ...
        get_filter_set_response_200.additional_properties = d
        return get_filter_set_response_200
