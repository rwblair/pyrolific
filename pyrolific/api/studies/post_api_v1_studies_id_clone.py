...
from ...models.post_api_v1_studies_id_clone_json_body import PostApiV1StudiesIdCloneJsonBody
...
def sync_detailed(
    ...
    *,
    ...
    To prevent repeat participation, a block list containing the original will be added to the
    duplicated study's eligibility requirements unless `block_previous_participants` is set to `false`
    in the request body.
