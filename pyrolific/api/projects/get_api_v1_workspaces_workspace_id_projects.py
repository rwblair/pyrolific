...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[ProjectShortListResponse]:
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[ProjectShortListResponse]:
    return Response(
