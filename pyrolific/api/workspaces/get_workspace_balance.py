...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[WorkspaceBalance]:
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[WorkspaceBalance]:
    return Response(
