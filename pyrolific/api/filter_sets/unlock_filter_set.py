...
def _get_kwargs(
    ...
    *,
    ...
    url = "{}/api/v1/filter-sets/{id}/unlock/".format(client.base_url, id=id)
...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[UnlockFilterSetResponse200]:
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[UnlockFilterSetResponse200]:
    return Response(
