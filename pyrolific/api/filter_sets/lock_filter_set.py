...
def _get_kwargs(
    ...
    *,
    ...
    url = "{}/api/v1/filter-sets/{id}/lock/".format(client.base_url, id=id)
...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[LockFilterSetResponse200]:
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[LockFilterSetResponse200]:
    return Response(
